...
% ***** Datasets to select *****
resultspath = '/Users/antoine/Google Drive/LabReasearch/Projects/FalconHawk';

%CTRL datasets
valid = 1; %1:4; % the catnum (i.e. input set) we want to keep for plots
...
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/10Hz/pairwise/10Hz GCyo gzn/Before/SimilarityAnalysis_GCbeforeGzn_BcapIsCompactness_10Hz_10to250ms.mat');
...
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/10Hz/pairwise/10Hz GCyo gzn/After/SimilarityAnalysis_GCafterGzn_BcapIsCompactness_10Hz_10to250ms.mat');
