...
% PatSep 
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/10Hz/pairwise/SimilarityAnalysis_GC_BcapIsCompactness_10Hz_5to2000ms.mat');
Collate{1} = Cdata; % GC
Valid{1} = [1, 3:12]; %[6, 10, 11]; %[4,5,7,8,9] %
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/FS/pairwise/SimilarityAnalysis_FS_BcapIsCompactness_10Hz_5to2000ms.mat');
Collate{2} = Cdata; % FS
Valid{2} = [1:5];
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/Hilus/pairwise/uptoDec2017/SimilarityAnalysis_HMC_BcapIsCompactness_10Hz_5to2000ms.mat');
Collate{3} = Cdata; % HMC
Valid{3} = [1:3];
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/CA3pyr_Gzine/30Hz/pairwise/SimilarityAnalysis_GCgzn_BcapIsCompactness_30Hz_5to2000ms.mat');
Collate{4} = Cdata; % GC+gzn 30Hz
Valid{4} = [1 2];
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/CA3pyr_Gzine/30Hz/pairwise/SimilarityAnalysis_CA3gzn_BcapIsCompactness_30Hz_5to2000ms.mat');
Collate{5} = Cdata; % CA3+gzn
Valid{5} = [1 2];
clearvars -except Collate Valid
...
Collate{6} = Cdata; % GCad SFrange FR
Valid{6} = 1;
clearvars -except Collate Valid
...
Collate{7} = Cdata; % GCad SFrange Burst
Valid{7} = 1;
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/10Hz/pairwise/10Hz GCyo gzn/Before/SimilarityAnalysis_GC_BeforeGzn_BcapIsCompactness_10Hz_5to2000ms.mat');
Collate{8} = Cdata; % GC before 100nm gzn, 10Hz
Valid{8} = 1;
clearvars -except Collate Valid
load('/Users/antoine/Google Drive/LabReasearch/Projects/PatSepSingleGC/upto12-06-2016/Analysis/10Hz/pairwise/10Hz GCyo gzn/After/SimilarityAnalysis_GC_AfterGzn_BcapIsCompactness_10Hz_5to2000ms.mat');
Collate{9} = Cdata; % GC after 100nm gzn, 10Hz
Valid{9} = 1;
clearvars -except Collate Valid
